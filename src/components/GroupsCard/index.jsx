...
const GroupsCard = ({GroupCoverImg, GroupProfileImg, GroupName, GroupSpecification, PrivateGroup}) => {
  return (
    <Container>
      ...
      <div className="group-info">
        ...
        <div className="info-group-specification">
            <span><PublicIcon className="group-specification-icon"/></span>{GroupSpecification} {PrivateGroup ? <LockIcon className="lock-group-icon"/> : ''}
        </div>
      </div>
